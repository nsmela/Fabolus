...
public class MouldStore {
    ...
    public MouldStore() {
        ...
        WeakReferenceMessenger.Default.Register<MouldGeneratorUpdatedMessage>(this, async (r,m) => await UpdateGenerator(m.Generator));
    ...
    private async Task UpdateGenerator(MouldGenerator generator) {
