...
public class SmoothingTests
{
    ...
    public void SmoothMesh_ValidMesh_ForksAndSmooths()
    {
        ...
        var result = _smoothingFeature.Execute(workspace, baseId, iterations: 1, intensity: 1.0f, ratio: 1.0);
        ...
        smoothedMesh.Metadata.IsSmoothed().Value.Should().BeTrue();
    }
    ...
    public void SmoothMesh_WithInflation_AppliesInflation()
    {
        ...
        var result = _smoothingFeature.Execute(workspace, baseId, iterations: 1, intensity: 1.0f, ratio: 1.0, inflation: 2.0f);
    ...
    public void SmoothMesh_AlreadyDerived_UpdatesExistingDerivedMesh()
    {
        ...
        // Smooth once
        workspace = _smoothingFeature.Execute(workspace, baseId, iterations: 1, intensity: 1.0f, ratio: 1.0).Value;
        var firstSmoothedId = workspace.ActiveMeshId;

        // Smooth again
        var result = _smoothingFeature.Execute(workspace, firstSmoothedId, iterations: 1, intensity: 1.0f, ratio: 1.0);
