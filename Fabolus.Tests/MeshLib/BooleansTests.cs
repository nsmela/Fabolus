...
public class BooleansTests
{
    ...
    public void Union_ReturnsCombinedWatertightMesh()
    {
        ...
        var statsA = _engine.GetStatistics(sphereA).Value;
        var statsB = _engine.GetStatistics(sphereB).Value;
        ...
        var unionStats = _engine.GetStatistics(union).Value;
        ...
        var validation = _engine.ValidateTopology(union).Value;
    ...
    public void Intersect_ReturnsIntersectionVolume()
    {
        ...
        var intersectStats = _engine.GetStatistics(intersect).Value;
