...
public sealed record MeshMetadata {
    ...
    /// </summary>
    public Result<Guid> DerivedFrom => GetProperty(CoreKeys.DerivedFrom);
    ...
    /// </summary>
    public Result<string> CreatedBy => GetProperty(CoreKeys.CreatedBy);
