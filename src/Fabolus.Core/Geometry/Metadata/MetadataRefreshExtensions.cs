...
public static class MetadataRefreshExtensions
{
    ...
    /// attaches them to <paramref name="metadata"/>, and returns a new <see cref="IMesh"/> with the updated metadata.AsFabolus().
    /// </summary>
        ...
        MeshMetadata metadata)
    {
        ...
        var refreshed = metadata.AsFabolus().WithProperties(m =>
        {
