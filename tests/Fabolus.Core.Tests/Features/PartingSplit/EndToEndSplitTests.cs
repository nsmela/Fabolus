...
public class EndToEndSplitTests
{
    ...
    public void Sphere_WithAirChannel_Mould_CanBeSplitAlongPartingLine()
    {
        ...
        var partingLineResult = new PartingLineFeature(_engine).Execute(mouldMesh, Vector3.UnitY);
        ...
        // 5. Split the mould along that parting line.
        var splitResult = new SplitMouldFeature(_engine).Execute(workspace, bodyId, partingLineResult.Value, Vector3.UnitY);
