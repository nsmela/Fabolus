...
public class PartingLineFeatureTests
{
    private readonly IGeometryEngine _engine;
    private readonly PartingLineFeature _sut;

    public PartingLineFeatureTests(GeometryEngineFixture fixture)
    {
        _engine = fixture.Engine;
        _sut = new PartingLineFeature(_engine);
    }
    ...
    public void Execute_Sphere_ReturnsOneLoop()
    {
        ...
        var result = _sut.Execute(sphereResult.Value, Vector3.UnitY);
    ...
    public void Execute_TorusThroughHole_ReturnsOuterAndInnerLoop()
    {
        ...
        var result = _sut.Execute(torusResult.Value, Vector3.UnitX);
    ...
    public void Execute_ZeroDirection_Fails()
    {
        ...
        var result = _sut.Execute(sphereResult.Value, Vector3.Zero);
